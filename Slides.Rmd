...
.pull-left[
* Since 1976;
* Most successful model of a multicampus university in Brazil;
* Campuses: one in Sao Paulo and **23** others strategically distributed throughout the State;
]

.pull-right[
```{r, out.width = "600px", fig.align="center", echo=FALSE}
knitr::include_graphics("images/SP.png")
```
]
...
## Conclusion:
.red[NO]: **intelligent systems will not (and need not) be foolproof**
...
# What is AI? 
```{r, out.width = "600px", fig.align="center", echo=FALSE}
knitr::include_graphics("images/AI_defs.png")
```
...
* Intractability (1960’s)
  ...
  + Intelligent behaviour = tractable subproblems, not large intractable problems.
* Probability
  + Gerolamo Cardano(1500’s) - probability in terms of outcomes of gambling events
...
* How do we do this when the payoff may be far in the future?
...
knitr::include_graphics("images/turing-test.jpg")
```
...
```{r, out.width = "600px", fig.align="center", echo=FALSE}
knitr::include_graphics("images/AI_Areas.png")
```
...
<iframe width="650" height="415" src="https://www.youtube.com/embed/p5U4NgVGAwgI?controls=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---
class: middle
# The Exercises
* We will use R language for implementing the examples of this course.
* In the lab session we will follow the [Software Carpentry Introduction to R resources](https://swcarpentry.github.io/r-novice-gapminder/);
